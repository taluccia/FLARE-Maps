...
fig_maps6 = ggdraw(xlim = c(0, 6), ylim = c(0, 7)) +
  ...
  draw_label("Alnus", x = 2.43, y = 4.5, fontfamily = "sans", fontface = "bold", color = "white", size = 10) +
  draw_label("ANS", x = 1.95, y = 5.1, fontfamily = "sans", fontface = "bold", color = "white", size = 10) +
