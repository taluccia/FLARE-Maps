...
```{r}
line1 = data.frame(x1 = 2.7, x2 = 5.2, y1 = 6.43, y2 = 6.25)
line2 = data.frame(x1 = 2.7, x2 = 5.1, y1 = 4.1, y2 = 6.15)
```
...
fig_maps6 = ggdraw(xlim = c(0, 6), ylim = c(0, 7)) +
  ...
  draw_plot(plot_transects5, x = 0.8, y = 3.75, width = 2, height = 3,scale =0.9) +
  ...
  draw_label("Alnus", x = 2.45, y = 4.4, fontfamily = "sans", fontface = "bold", color = "white", size = 10) +
  draw_label("ANS", x = 1.95, y = 5.0, fontfamily = "sans", fontface = "bold", color = "white", size = 10) +
  draw_label("BP", x = 1.4, y = 5.45, fontfamily = "sans", fontface = "bold", color = "white", size = 10) +
  draw_label("CN", x = 2.1, y = 6.35, fontfamily = "sans", fontface = "bold", color = "white", size = 10) +
