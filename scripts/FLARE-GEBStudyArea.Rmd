...
fig_fires = cowplot::ggdraw(map2) + 
  ...
  draw_label(label="Cherskiy", fontfamily = "sans", fontface = "bold", color = "black", size = 9,  x=.58, y=.89)
...
fig1 = ggdraw(xlim = c(0, 6), ylim = c(0, 7)) +
  draw_plot(fig_eco, x = .35, y = 4.51, width = 3, height = 2.5) +
  draw_plot(fig_fires, x = 0.5, y = -0.02, width = 5, height = 4.5, scale = 1.05) +
...
fig2 = ggdraw(xlim = c(0, 6), ylim = c(0, 7)) +
  draw_plot(fig_eco, x = 1.5, y = 4.51, width = 3, height = 2.5) +
  draw_plot(fig_fires, x = 0.5, y = -0.02, width = 5, height = 4.5, scale = 1.05) +


  draw_label("(a)", x = 0.25, y = 6.8, fontfamily = "sans", fontface = "bold", color = "black", size = 14) +

  draw_label("(b)", x = 0.25, y = 4.2, fontfamily = "sans", fontface = "bold", color = "black", size = 14)
...
```{r fig.height=5, fig.width=6}
ggdraw(xlim = c(0, 6), ylim = c(0, 5)) +
  draw_plot(map3, x = -.1, y = -0.1, width = 6, height = 5, scale = 1.0) + 
  
  draw_plot(legend1, x=1.5, y=4.25, width=.5, height=.1) +
  
  draw_label(label="Cherskiy", fontfamily = "sans", fontface = "bold", color = "black", size = 9,  x=4.5, y=5.8) +
  
draw_plot(fig_eco, x = 3, y = 0, width = 3, height = 2.5) 
