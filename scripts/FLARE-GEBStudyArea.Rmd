...
fig_eco = cowplot::ggdraw(map1) + 
  draw_label(label="Cherskiy", fontfamily = "sans", fontface = "plain", color = "black", size = 5,  x=.63, y=.69) +
  draw_label(label="Yakutsk", fontfamily = "sans", fontface = "plain", color = "black", size = 5,  x=.5, y=.46) +
  ...
  draw_label(label="Arctic Circle", fontfamily = "sans", fontface = "plain", color = "white", size = 5,  x=.33, y=.52) +
...
fig_fires = cowplot::ggdraw(map2) + 
  draw_plot(legend1, x=.14, y=.7, width=.3, height=.1) 
