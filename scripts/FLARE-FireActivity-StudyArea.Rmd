...
sa_legend <- ggplot() +
  ...
  scale_fill_manual(values=ecoPalette, labels = c("BT", "CKMT", "CPT", "EST", "NSCT", "NST", "SSFS",  "TCST", "TBBMT")) +
coord_sf(xlim = c(-2934205, 4133752), ylim = c(-1122562, 3493703)) +
  ...
  theme(legend.title = element_blank(), 
        ...
        legend.background = element_rect(fill = "white", colour = "white", size = 3)) + theme(plot.margin=grid::unit(c(0,0,0,0), "mm")) +
...
sa_map <- ggplot() +
  ...
  theme(legend.title = element_blank(), 
        legend.position= c(.5, -.05), 
         legend.key.height = unit(.2, 'in'), #change legend key height
        legend.key.width = unit(.2, 'in'), #change legend key width
         axis.text.x=element_blank(),
        axis.ticks.x=element_blank(), 
        axis.text.y=element_blank(), 
        axis.ticks.y=element_blank()) +
...
plot1 = cowplot::plot_grid(sa_map, legend, ncol = 1, rel_heights = c(1, .1)) 
plot1
```
...
map1 = cowplot::ggdraw(sa_map) + 
  ...
  draw_label(label="China", fontfamily = "sans", fontface = "plain", color = "black", size = 11, x=.65, y=.18) +
  draw_label(label="Mongolia", fontfamily = "sans", fontface = "plain", color = "black", size = 11,  x=.45, y=.18) +
  ...
  draw_label(label="Yakutsk", fontfamily = "sans", fontface = "plain", color = "white", size = 10,  x=.62, y=.45) +
  draw_label(label="Chersky", fontfamily = "sans", fontface = "plain", color = "white", size = 10,  x=.67, y=.675)
